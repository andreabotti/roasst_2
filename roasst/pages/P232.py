...
chart_KL = html.Div(
    ...
    children=[
        dcc.Graph(
            id='P232_RP_BarChart_KL',   style={'height': '1000px'},
            figure={},
            ),
        ],
    )
chart_BD1 = html.Div(
    ...
    children=[
        dcc.Graph(id='P232_RP_BarChart_BD1',  style={'height': '800px'},  figure={},),
        ],
    )
charts = html.Div(
    # className='row',
...
input_menus = html.Div(
    ...
    children=[
        ...
        dash_create_menu_weather(
            menu_id=['input_W1_P232','input_W2_P232'],
        ...
        dash_create_menu_radio_floor(
            menu_id='input_F_P232', col=Fcol,
            width='row', df=df_sji,
            ),
        dash_create_menu_vnt(df=df_sji,
            menu_id=['input_VNT_KL_P232','input_VNT_B_P232'],
            cols=[vBcol,vKLcol],
            width='row', 
            ),
        html.Hr(
        ...
        dash_create_menu_window_width(df=df_sji,
            menu_id=['input_WW_KL_P232','input_WW_B_P232'],
            cols=[wwBcol,wwKLcol],
            width='row',
            ),
        html.Hr(
...
#
@app.callback(
    Output('P232_RP_BarChart_KL', 'figure'),
    [
        Input('input_T1_P232', 'value'),
        Input('input_W1_P232', 'value'), Input('input_W2_P232', 'value'),
        Input('input_F_P232', 'value'),
        Input('input_VNT_B_P232', 'value'), Input('input_VNT_KL_P232', 'value'),
        Input('input_WW_B_P232', 'value'), Input('input_WW_KL_P232', 'value'),
        Input('input_G_P232', 'value'),
        Input('input_crit_P232', 'value'),
    ])

def update_P232_Polar_RP_KL(
    T_value,
    W1_value, W2_value,
    F_value,
...
#
    R = 'KL'
    P232_chart_data = []
    P232_chart_layout = create_layout_P232_chart_KL()
    ...
    for T in T_value:
        ...
        P232_chart_data.append(trace_GF)
        ...
        P232_chart_data.append(trace_MF)
        ...
        P232_chart_data.append(trace_TF)

    #

    P232_chart = go.Figure(
        data=P232_chart_data,
        layout=P232_chart_layout,
        )
    return P232_chart
...
@app.callback(
    Output('P232_RP_BarChart_BD1', 'figure'),
    [
        Input('input_T1_P232', 'value'),
        Input('input_W1_P232', 'value'), Input('input_W2_P232', 'value'),
        Input('input_F_P232', 'value'),
...
def update_P232_RP_BarChart_BD1(
    T_value,
    W1_value, W2_value,
    F_value,
    VNT_B_value, VNT_KL_value,
